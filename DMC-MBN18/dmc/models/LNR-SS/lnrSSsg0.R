...
# VARIANT of lnrSSsg.R:  BALLISTIC ASSUMPTION (cant stop response production)
#  THIS VERSION FORCES sg=0, dont need to include t0sg in the model (if it is
#  inlcuded it is overwritten).
#
