...
model <- model.dmc(p.map=list(A="1",B="SA",D="SA",mean_v=c("D","M"),sd_v="1",t0="SA",st0="1"),
                   ...
                   responses=c("LEFT","RIGHT"),responses2=c("1","2"),type="norm2TC")
...
#Often high confidence incorrect is more common than low confidence.
#Problem with math, or parameter values?
